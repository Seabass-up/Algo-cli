...
SOURCE_PATHS = (
    ...
    "algo_cli/evals/grounded_answers.py",
    ...
    "tests/test_grounded_answer_runner.py",
    "scripts/grounded_retrieval_qualification.py",
    "scripts/grounded_answer_qualification.py",
    ...
    ".github/workflows/oliver-draft-capture.yml",
...
FOCUSED_TESTS = (
    ...
    "tests/test_oliver_draft_capture.py",
