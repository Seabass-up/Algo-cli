...
CURATED_TOOL_POLICIES: dict[str, CuratedActionPolicy] = {
    ...
    **{
    ...
    "cleanup_pdf_render_artifact": _local(
        Capability.DESTRUCTIVE,
    ...
    "jev_question_contract": CuratedActionPolicy(
        ...
        (DataClass.LOCAL_CONTENT, DataClass.SENSITIVE), TargetScope.PROVIDER,
        IdempotencyClass.NON_IDEMPOTENT, OutcomeModel.UNKNOWN_POSSIBLE,
        VerificationRequirement.STRUCTURED_RESULT, dynamic_resolution=True, suppress_logs=True,
    ),
    ...
    "cobalt_open": _external(risk="medium"),
    "cobalt_snapshot": _read(
        Capability.NETWORK,
        data=(DataClass.PUBLIC,),
        target=TargetScope.EXTERNAL_STATE,
        confirmation=ConfirmationMode.SESSION_PREAPPROVAL,
        risk="low",
        outcome=OutcomeModel.DETERMINISTIC,
    ),
    "cobalt_screenshot": _read(
        Capability.NETWORK,
        data=(DataClass.PUBLIC,),
        target=TargetScope.EXTERNAL_STATE,
        confirmation=ConfirmationMode.SESSION_PREAPPROVAL,
    ...
    "cobalt_navigate": _external(risk="medium"),
    "cobalt_click": _external(risk="medium"),
    "cobalt_type": _external(risk="medium"),
    "cobalt_scroll": _external(risk="low"),
    "cobalt_close": _external(risk="low"),
}
