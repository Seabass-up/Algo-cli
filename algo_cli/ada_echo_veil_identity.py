...
QUALIFIED_ECHO_SOURCE_PATHS = (
    ...
    "echo_veil/attestation_binding.py",
    "echo_veil/azure_attestation.py",
    "echo_veil/backup.py",
    "echo_veil/capability.py",
    "echo_veil/caretaker.py",
    "echo_veil/cloudflare_provider.py",
    "echo_veil/codex_artifact.py",
    ...
    "echo_veil/key_custody.py",
    "echo_veil/local_authority.py",
    "echo_veil/local_readiness.py",
    "echo_veil/memory_layers.py",
    "echo_veil/migration.py",
    "echo_veil/oracle.py",
    "echo_veil/persistence.py",
    "echo_veil/preflight_receipt.py",
    "echo_veil/protocol_compat.py",
    "echo_veil/proximity.py",
    "echo_veil/readiness_store.py",
    "echo_veil/record_envelope.py",
    ...
    "echo_veil_origin/native_attestation.py",
    "echo_veil_origin/openfhe_engine.py",
    "echo_veil_origin/proof_verifier.py",
)
QUALIFIED_ECHO_SOURCE_TREE_SHA256 = "10633f9264640d3022234a19708b06c5851428722ac33a7739873e8b934cd3d7"
