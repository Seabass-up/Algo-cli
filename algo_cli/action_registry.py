...
ACTION_SPECS: tuple[ActionSpec, ...] = (
    ...
    _spec(
        "/capabilities",
        "slash",
        "Show a compact capability readiness table.",
        "session",
        ("readiness", "read-only"),
        "Shows which integrations are configured and allowed without contacting them.",
        "low",
        False,
        False,
        True,
    ...
    _spec(
        ...
        True,
        known_limitations=(
            "Kernel capability contract; execute it through the read-only extensions_manifest_build tool.",
        ),
    ),
    _spec(
    ...
    _spec(
        "capability_status",
        "tool",
        "Report whether a capability is supported, configured, allowed, and verified in this session.",
        "session",
        ("readiness", "discovery", "read-only", "local"),
        "Reports local setup and policy readiness without network calls, prompts, or grants.",
        "low",
        False,
        False,
        True,
    ...
    _spec(
        "cobalt_open",
        "tool",
        "Open a URL in the local Camoufox browser service.",
        "browser",
        ("browser", "camoufox", "network", "external"),
        "Opens a tab without writing local state; navigation is observable.",
        "medium",
        False,
        False,
        True,
    ...
    _spec(
        ...
        "browser",
        ("browser", "camoufox", "read-only", "external"),
        "Read-only page structure for evidence gathering.",
        "low",
        False,
        False,
        True,
    ...
    _spec(
        "cobalt_screenshot",
        "tool",
        "Capture and vision-describe a screenshot of a browser tab.",
        "browser",
        ("browser", "camoufox", "vision", "external"),
        "Visual evidence of the rendered page state.",
        "low",
        False,
        False,
        True,
    ...
    _spec(
        ...
        "browser",
        ("browser", "camoufox", "network", "external"),
        "Changes the page in an existing tab; observable via snapshot.",
        "medium",
        False,
        False,
        True,
    ...
    _spec(
        "cobalt_click",
        "tool",
        "Click an element in a browser tab by ref or selector.",
        "browser",
        ("browser", "camoufox", "interaction", "external"),
        "Triggers page-side effects; snapshot afterward to verify.",
        "medium",
        False,
        False,
        False,
    ...
    _spec(
        ...
        "browser",
        ("browser", "camoufox", "interaction", "input", "external"),
        "Sends typed input to a page element; may submit forms.",
        "medium",
        False,
        False,
        False,
    ...
    _spec(
        ...
        "browser",
        ("browser", "camoufox", "interaction", "external"),
        "Changes viewport position; observable via snapshot.",
        "low",
        False,
        False,
        True,
    ...
    _spec(
        ...
        "Close a browser tab.",
        "browser",
        ("browser", "camoufox", "lifecycle", "external"),
        "Cleans up a tab; no persistent state remains.",
        "low",
        False,
        False,
        True,
