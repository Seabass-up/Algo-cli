...
def _build_evidence(*, source_digest: str = _digest("c")) -> dict[str, object]:
    ...
    return {
        ...
        "browser_security_latest_version": "154.0.8037.57",
        "browser_security_latest_release_at_ms": 1_790_100_540_403,
        "browser_security_evidence_observed_at_ms": 1_790_100_541_000,
