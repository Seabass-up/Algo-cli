...
def _build_evidence(*, source_digest: str = _digest("c")) -> dict[str, object]:
    ...
    return {
        ...
        "browser_security_latest_version": "153.0.8010.52",
        "browser_security_latest_release_at_ms": 1_789_692_582_244,
        "browser_security_evidence_observed_at_ms": 1_789_692_583_000,
