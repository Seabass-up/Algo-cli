...
from algo_cli.dorothy_perf_telemetry import runtime_quality_snapshot
from algo_cli.theodore_runtime_qos import SpawnClass, classify_tool_runtime, named_tool_log_path
...
def test_model_arguments_cannot_suppress_runtime_logs() -> None:
    hint = classify_tool_runtime("read_file", {"suppress_log": True})

    assert hint.log_suppression is False
    assert hint.log_path != "/dev/null"
