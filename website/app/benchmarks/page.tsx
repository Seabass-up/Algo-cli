...
export default function BenchmarksPage() {
  return <PageFrame eyebrow="EVIDENCE / 2026-07-11" title="Show the receipts." intro="Our first public comparison is deliberately small, balanced, revision-pinned, and explicit about what it cannot prove.">
    <section className="content-wrap">
      <div className="benchmark-summary"><div><Pill tone="lime">OBJECTIVE RANK 01</Pill><strong>9/9</strong><span>Algo CLI checker passes</span></div><p>Three draft tasks, three repetitions per harness, one local Qwen model, one machine, and balanced run order. Every harness occupied positions one, two, and three exactly once per task.</p></div>
      ...
      <div className="claim-guard"><h2>What this supports</h2><p>“Algo CLI ranked first on this balanced 27-run local benchmark.”</p><h2>What this does not support</h2><p>Universal superiority, meaningful speed leadership over Pi, or greater underlying model power. The suite is too small and uses only one model and machine.</p><a className="button secondary" href="/benchmarks/summary.json">Open the JSON summary →</a></div>
    </section>
  </PageFrame>;
}
