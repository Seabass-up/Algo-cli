...
export default function DocsPage() {
  return <PageFrame eyebrow="DOCS / v0.20.0" title="Operate the runtime deliberately." intro="A compact field guide to the controls that matter most. Every feature is designed to reveal its scope, authority, and verification state.">
