...
export default function InstallPage() {
  return <PageFrame eyebrow="INSTALL / v0.14.0 RC" title="Start local. Add only what you need." intro="Algo CLI requires Python 3.10 or newer. Version 0.14.0 is a release candidate; use a reviewed checkout today and switch to an index install after PyPI publication.">
    <section className="content-wrap">
      <div className="notice"><Pill tone="lime">RELEASE CANDIDATE</Pill><p>Repository review, hosted CI, and package publication are the remaining release steps.</p></div>
      <div className="install-grid">
        <article className="install-card featured"><span>01 / RELEASE CANDIDATE</span><h2>Install a reviewed checkout</h2><p>Clone the reviewed repository, then let Pipx isolate the application and its dependencies.</p><CopyInstall command="git clone https://github.com/Seabass-up/Algo-cli.git && cd Algo-cli" /><CopyInstall command="pipx install . && algo-cli doctor" /></article>
