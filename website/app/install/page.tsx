...
export default function InstallPage() {
  return <PageFrame eyebrow="INSTALL / v0.16.0" title="Start local. Add only what you need." intro="Algo CLI v0.16.0 is available from PyPI for Python 3.10 or newer. The algo-cli-runtime distribution installs the algo-cli command.">
    <section className="content-wrap">
      <div className="notice"><Pill tone="lime">STABLE RELEASE</Pill><p>Version 0.16.0 is published from the reviewed v0.16.0 tag through protected OIDC publishing.</p></div>
